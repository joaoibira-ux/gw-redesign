...
Essa tela é a ÚNICA fonte de pendências agora — a nota antiga no Obsidian (`03 - Nosso/Sistemas - Pendencias/2026-08-07 - Pendências Green Wall.md`) foi arquivada em 2026-08-27 (movida pra `00 - Sistema/Arquivo morto/` no vault) porque o João achou o fluxo por lá pouco prático. Não reviva esse fluxo nem sugira usar o Obsidian pra pendências do GW de novo.
